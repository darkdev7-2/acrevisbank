        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center space-x-6">
                    <!-- Career -->
                    <a href="{{ route('career.index', ['locale' => $currentLocale]) }}" class="flex flex-col items-center group">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open" type="button" class="flex items-center space-x-1 text-sm font-medium text-gray-600 hover:text-gray-900 focus:outline-none">
                        ...
                        <div x-show="open"
                            ...
                            @foreach(['fr', 'de', 'en', 'es'] as $locale)
                                <a href="{{ route('locale.switch', ['locale' => $locale]) }}"
                                   class="block px-4 py-2 text-sm {{ $currentLocale === $locale ? 'bg-pink-50 text-pink-600 font-medium' : 'text-gray-700 hover:bg-gray-100' }}">
                                    @if($locale === 'fr')
                                        🇫🇷 Français
                                    @elseif($locale === 'de')
                                        🇩🇪 Deutsch
