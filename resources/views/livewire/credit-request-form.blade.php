<div>
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <!-- Form -->
        <form wire:submit.prevent="{{ $currentStep == $totalSteps ? 'submit' : 'nextStep' }}" class="bg-white rounded-lg shadow-lg p-8">
            ...
            <div class="flex justify-between mt-8 pt-6 border-t border-gray-200">
                ...
                <button type="button"
                        ...
                        class="px-6 py-3 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50 font-medium transition-colors">
                    {{ $t['previous'] }}
                </button>
                @else
                <div></div>
                ...
                <button type="submit"
                        class="px-6 py-3 bg-pink-600 hover:bg-pink-700 text-white rounded-md font-medium transition-colors">
                    {{ $t['next'] }}
                </button>
                @else
                <button type="submit"
                        class="px-8 py-3 bg-pink-600 hover:bg-pink-700 text-white rounded-md font-semibold transition-colors">
                    {{ $t['submit'] }}
                </button>
                @endif
            </div>
