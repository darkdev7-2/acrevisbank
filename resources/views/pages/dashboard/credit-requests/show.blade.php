    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-6">
                ...
                <!-- Quick Info -->
                <div class="bg-gradient-to-br from-pink-50 to-purple-50 rounded-lg shadow-sm p-6 border border-pink-100">
                ...
                <a
                    href="{{ route('dashboard.credit-requests.index', ['locale' => app()->getLocale()]) }}"
                    class="block w-full text-center px-6 py-3 bg-gradient-to-r from-pink-600 to-pink-700 text-white rounded-lg hover:from-pink-700 hover:to-pink-800 transition-all shadow-md hover:shadow-lg"
                >
