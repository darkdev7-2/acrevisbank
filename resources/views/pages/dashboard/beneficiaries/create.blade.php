    ...
    <div class="py-12 bg-gray-50 min-h-screen">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-lg shadow-md p-8">
                ...
                <form method="POST" action="{{ route('dashboard.beneficiaries.store', ['locale' => $currentLocale]) }}" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <input type="text" id="iban" name="iban" value="{{ old('iban') }}" required
                    ...
                    <div>
                        ...
                        <textarea id="notes" name="notes" rows="3"
                                  ...
                                  class="w-full px-4 py-3 border border-gray-300 rounded-md focus:ring-pink-500 focus:border-pink-500">{{ old('notes') }}</textarea>
                    </div>

                    <!-- Is Favorite -->
                    <div class="flex items-center">
                        <input type="checkbox" id="is_favorite" name="is_favorite" value="1" {{ old('is_favorite') ? 'checked' : '' }}
