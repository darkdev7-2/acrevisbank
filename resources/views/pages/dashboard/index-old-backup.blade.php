    ...
    <div class="py-8 bg-gray-50 min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @if(session('transfer_success'))
                <div class="mb-6 bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-300 rounded-lg p-6 shadow-md">
                    <div class="flex items-start justify-between">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="mt-2 space-y-1">
                                    <p class="text-sm text-green-800">
                                        ...
                                        <span class="font-mono">{{ session('transfer_success')['reference'] }}</span>
                                    </p>
                                    <p class="text-sm text-green-800">
                                        <span class="font-medium">Montant:</span>
                                        <span class="font-bold">{{ number_format(session('transfer_success')['amount'], 2, '.', "'") }} CHF</span>
                                    </p>
                                    <p class="text-sm text-green-800">
                                        <span class="font-medium">Bénéficiaire:</span>
                                        {{ session('transfer_success')['recipient_name'] }}
                                    </p>
                        ...
                        <a href="{{ route('dashboard.transaction.receipt', ['locale' => $currentLocale, 'transactionId' => session('transfer_success')['transaction_id']]) }}"
                           target="_blank"
                           class="inline-flex items-center px-4 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors font-medium shadow-sm hover:shadow-md">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
